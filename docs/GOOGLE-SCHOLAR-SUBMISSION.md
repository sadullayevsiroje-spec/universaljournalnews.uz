...
**Journal Information:**
- Journal Name: Universal Journal News
- Short Name: UJN
- Website: https://universaljournalnews.uz
- Language: English
- Subject: Multidisciplinary (All fields of science, technology, medicine, social sciences, and humanities)
- Publisher: Universal Journal News
- Country: Uzbekistan

**Technical Details:**
- Platform: Next.js (Custom CMS)
- Access: Open Access
- Format: PDF + HTML
...
2. https://universaljournalnews.uz/articles/Article-2
...
- All PDFs are freely accessible
- ISSN: Application in progress

---

## Email Template for Google Scholar

**To:** scholar-publishers-support@google.com
**Subject:** Inclusion Request: Universal Journal News

**Email Body:**

Dear Google Scholar Team,

I am writing to request the inclusion of Universal Journal News (UJN) in Google Scholar's index.
...
We have ensured that our website follows Google Scholar's inclusion guidelines and technical requirements. We would be grateful if you could review our journal for inclusion in Google Scholar.

Please let me know if you need any additional information or if there are any issues that need to be addressed.
...
Editor-in-Chief
Universal Journal News
Email: sadullayev.siroje@gmail.com
Website: https://universaljournalnews.uz

---

## Alternative: Google Scholar Inclusion Form

If email doesn't work, you can also try the official form:
...
1. **Response Time:** 2-6 weeks for initial review
2. **Indexing Time:** 1-3 months after approval
3. **Follow-up:** If no response in 6 weeks, send a polite follow-up email

## After Submission:

1. Monitor Google Scholar for your articles (search by title)
2. Check Google Search Console for crawl errors
3. Keep publishing quality content
4. Maintain consistent metadata

## Verification:

After a few weeks, search for your articles in Google Scholar:
- Search: "Universal Journal News"
- Search: [Article Title]
- Search: site:universaljournalnews.uz

---

## Notes:

- ISSN application is in progress (not required for initial submission)
- DOI will be added in future (not required for initial submission)
- All technical requirements are met
- Website is stable and hosted on Vercel
